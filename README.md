...
### **선택4) 실시간 배달원 위치 확인(Redis)** -현중

- 고객은 배달원의 위치를 실시간으로 볼 수 있습니다.
- Redis의 Geospatial 라이브러리를 이용해, 배달원과 주문고객의 집 위치 차이값을 반환 해줍니다.
 <img width="1473" alt="스크린샷 2024-10-02 16 22 15" src="https://github.com/user-attachments/assets/9e19b9ff-55b7-4142-a6a8-ce2e0da9bee6">
